...
result_path="${RESULT_BUNDLE_PATH:-$project_root/.build/functional-tests.xcresult}"
...
xcodebuild test \
  ...
  -skip-testing:MultiCurrencyLedgerUITests/MultiCurrencyLedgerPerformanceUITests \
